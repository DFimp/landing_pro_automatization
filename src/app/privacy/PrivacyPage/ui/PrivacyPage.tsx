        ...
        <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-h7">
              <div>
                <p>
                  ...
                  предприниматель Щербаев Андрей Олегович
                </p>
                <p>
                  <strong>Сокращенное наименование:</strong> ИП Щербаев А.О.
                </p>
                <p>
                  <strong>ИНН:</strong> 262610337108
                </p>
                <p>
                  <strong>ОГРНИП:</strong> 324265100129393
                </p>
              </div>
              <div>
                <p>
          ...
          <section className="bg-light-blue2 p-6 rounded-lg mt-8">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>ИП Щербаев Андрей Олегович</strong>
              </p>
              <p>
                <strong>ИНН:</strong> 262610337108
              </p>
