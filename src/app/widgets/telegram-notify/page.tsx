...
export default function TelegramWidget() {
    ...
    return (
        <main id="telegram-widget" className="sm:pb-20 sm:pt-20 bg-white">
            {/* Hero Section */}
            <section id={isIframe ? "hidden-in-iframe" : ""} className="container mx-auto px-4 pb-16 bg-white">
                <div className="text-center space-y-6">
                    ...
                    <div className="flex flex-col gap-3 justify-center items-center mb-10">
                        <a href='https://www.amocrm.ru/oauth/?state=state&mode=popup&client_id=26e34407-779d-4b47-bb48-b1ffaed3cc78' target="_blank" rel="noopener">
