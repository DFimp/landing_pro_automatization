...
export default function MassiveLeadsWidget() {
  ...
  return (
    <main id="massive-leads-widget" className="sm:pb-20 sm:pt-20 bg-white">
      {/* Hero Section */}
      <section
        id={isIframe ? "hidden-in-iframe" : ""}
        className="container mx-auto px-4 pb-16 bg-white"
      >
      ...
      <section
        id={isIframe ? "hidden-in-iframe" : ""}
        className="container mx-auto px-4 animate-fade-in-up bg-white"
      >
          ...
          {[
            {
              ...
              description:
                "Создавайте сделки для сотен контактов одновременно. То, что раньше занимало часы, теперь делается за минуты!",
            },
            {
              icon: "🎯",
              title: "Умная фильтрация контактов",
              description:
                "Выбирайте контакты по любым критериям или загружайте готовый список. Точное попадание в целевую аудиторию!",
            },
            {
              icon: "🏷️",
              title: "Автоматическое добавление тегов",
              description:
                "Создавайте новые теги и автоматически применяйте их ко всем новым сделкам. Идеальная сегментация с самого начала!",
            },
            {
              icon: "📊",
              title: "Выбор воронки и этапа",
              description:
                "Размещайте сделки точно в нужную воронку и этап. Никакой путаницы - всё структурировано с первого дня!",
            },
            {
              icon: "🔄",
              title: "Отслеживание прогресса",
              description:
                "Видите статус каждой операции в реальном времени. Полный контроль над процессом создания сделок!",
            },
            {
              icon: "📱 ",
              title: "Простота использования",
              description:
                "Интуитивный интерфейс без сложных настроек. Освоите за 5 минут, сэкономите час!",
            },
          ].map((feature, index) => (
            <div
              key={index}
            ...
            {[
              {
                ...
                description:
                  "У вас есть база из 500 потенциальных клиентов из новой рекламы? Создайте для всех сделки за 2 минуты вместо 5 часов ручной работы.",
              },
              {
                icon: "🎪",
                title: "Участие в выставке или событии",
                description:
                  "Собрали 200 контактов на выставке? Мгновенно создайте сделки с тегом 'Выставка 2025' и начинайте отработку, пока интерес клиентов горячий.",
              },
              {
                icon: "📧",
                title: "Email-маркетинг кампании",
                description:
                  "Планируете отправить предложение всем клиентам из определенного сегмента? Создайте сделки заранее и отслеживайте конверсию каждого письма.",
              },
              {
                icon: "🔄",
                title: "Реактивация старых клиентов",
                description:
                  "Хотите вернуть клиентов, которые не покупали больше года? Создайте сделки для всех неактивных контактов с тегом 'Реактивация'.",
              },
              {
                icon: "🎁",
                title: "Сезонные акции и распродажи",
                description:
                  "Новогодняя распродажа для всех VIP-клиентов? Создайте персональные сделки для каждого и предложите индивидуальные условия.",
              },
              {
                icon: "👥",
                title: "Работа с партнерскими базами",
                description:
                  "Получили список потенциальных клиентов от партнера? Быстро создайте сделки с соответствующими тегами и воронкой.",
              },
            ].map((useCase, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 hover:transform hover:scale-105"
              >
      ...
      >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8">
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    ...
                    <ul className="space-y-2 ml-4">
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                        <span>
                          Перейдите в «Контакты» в разделе «Списки» в amoCRM
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                      ...
                      <div>
                        ...
                        <p className="mb-3">
                          Укажите в интерфейсе amoCRM нужные фильтры, виджет сам
                          найдет нужные контакты и создаст для них сделки
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mb-3">
                          Выберите конкретных контактов из списка - отметьте
                          галочками тех, для кого создавать сделки
                        </p>
                        <ul className="space-y-2 ml-4"></ul>
                      </div>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                        <span>
                          В левом верхнем углу активируется кнопка «Создать
                          сделки», наведитесь на нее чтобы она выехала из
                          боковой панели
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mb-3">
                        Укажите понятное название, которое будет у всех
                        создаваемых сделок:
                      </p>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 ml-4">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-blue-600">•</span>
                          <span>
                            Все сделки будут созданы на выбранном этапе
                          </span>
                        </li>
                      </ul>
                    </div>
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            ...
                            <code className="bg-white px-2 py-1 rounded">
                              холодный лид, реклама, москва
                            </code>
                          </li>
                          <li>
                            •{" "}
                            <code className="bg-white px-2 py-1 rounded">
                              выставка, горячий, b2b
                            </code>
                          </li>
                          <li>
                            •{" "}
                            <code className="bg-white px-2 py-1 rounded">
                              реактивация, vip, повторная продажа
                            </code>
                          </li>
                        </ul>
                        <p className="text-xs text-gray-600 mt-2">
                          Если тега не существует, он будет создан автоматически
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    ...
                    <ul className="space-y-2 ml-4">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                        <span>
                          Убедитесь, что количество сделок соответствует
                          ожиданиям
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-blue-700 mt-1">
                            Виджет покажет прогресс-бар во время создания
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-yellow-700 mt-1">
                            Создание 100 сделок занимает примерно 1-2 минуты. Не
                            закрывайте страницу до завершения!
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            {/* Step 6 */}
            <div
              className="bg-white rounded-3xl p-8 transition-all duration-500 mb-16"
              style={{
                boxShadow:
                  "0 15px 35px -5px rgba(0, 0, 0, 0.25), 0 15px 20px -10px rgba(0, 0, 0, 0.2)",
                border: "1px solid rgba(0, 0, 0, 0.1)",
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    ...
                    <ul className="space-y-2 ml-4">
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                        <span>
                          Перейдите в выбранную воронку и проверьте результат
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600">•</span>
                        <span>
                          Используйте созданные теги для быстрой фильтрации
                        </span>
                      </li>
                    </ul>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-green-700 mt-1">
                            Вы успешно создали множество сделок одновременно.
                            Теперь можете сосредоточиться на продажах!
                          </p>
                        </div>
                      </div>
                    </div>
