                        ...
                        {[
                            {
                                ...
                                description: "Мгновенно получайте уведомления о новых заявках и сразу связывайтесь с клиентом. Кнопка &ldquo;Позвонить сейчас&rdquo; запустит создание задачи на звонок."
                            },
                            {
                                icon: "📊",
                                title: "Контроль воронки продаж",
                                description: "Отслеживайте движение сделок по этапам. Автоматически отправляйте следующие материалы при переходе на новый этап."
                            },
                            {
                                icon: "👥",
                                title: "Командная работа",
                                description: "Уведомляйте руководителей о крупных сделках, а коллег - о необходимости подменить на встрече."
                            },
                            {
                                icon: "🚨",
