...
//     return (
//         <main id="whatsapp-widget" className="sm:pb-20 sm:pt-20 bg-white">
//             {/* Hero Section */}
...
//                         <a href='https://www.amocrm.ru/oauth/?state=state&mode=popup&client_id=667e5134-9be1-4ee1-8e02-42eb25230f37' target="_blank" rel="noopener">
