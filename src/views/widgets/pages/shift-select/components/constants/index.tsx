...
export const STEPS = [
    ...
    {
        title: "Использование опорного чекбокса, Shift и протягивания",
        content: (
            <div>
                <p>Теперь протестируйте основные сценарии работы:</p>
                <ul className="sc-list">
                    <li>
                        Сначала сделайте обычный клик по нужному чекбоксу — виджет
                        запомнит его как опорный для следующего диапазона.
                    </li>
                    <li>
                        Затем зажмите <b>Shift</b> и кликните по другому чекбоксу —
                        виджет выделит все строки между опорным и текущим чекбоксом,
                        включая оба.
                    </li>
                    <li>
                        Если нужно быстро пройтись подряд по нескольким строкам,
                        зажмите <b>левую кнопку мыши</b> на чекбоксе и протяните курсор
                        по списку — виджет сразу применит выделение к диапазону.
                    </li>
                    <li>
                        Чтобы начать новый диапазон, просто сделайте обычный клик по
                        другому чекбоксу: он сохранится как новая опорная точка.
                    </li>
                </ul>
