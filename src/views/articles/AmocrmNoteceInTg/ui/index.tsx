...
import NoteceInTgContentSection from "./NoteceInTgContentSection/NoteceInTgContentSection";

const article = ARTICLES_DATA["amocrm-notice-in-tg"];

export default function AmocrmNoteceInTgArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
