...
import IntegrationOneCContentSection from "./IntegrationOneCContentSection/IntegrationOneCContentSection";

const article = ARTICLES_DATA["amocrm-integration-1c"];

export default function AmocrmIntegrationOneCArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
