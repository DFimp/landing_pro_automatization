...
import IntegrationTelContentSection from "./IntegrationTelContentSection/IntegrationTelContentSection";

const article = ARTICLES_DATA["amocrm-integration-tel"];

export default function AmocrmIntegrationTelArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
