...
import SettingItselfContentSection from "./SettingItselfContentSection/SettingItselfContentSection";

const article = ARTICLES_DATA["amocrm-setting-itself"];

export default function AmocrmSettingItselfArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
