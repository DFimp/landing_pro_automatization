...
import RealHelpContentSection from "./RealHelpContentSection/RealHelpContentSection";

const article = ARTICLES_DATA["amocrm-real-help"];

export default function AmocrmRealHelpArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
