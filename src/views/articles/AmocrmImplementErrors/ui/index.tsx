...
import ImplementErrorsContentSection from "./ImplementErrorsContentSection/ImplementErrorsContentSection";

const article = ARTICLES_DATA["amocrm-implement-errors"];

export default function AmocrmImplementErrorsArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
