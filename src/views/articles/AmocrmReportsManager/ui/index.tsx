...
import ReportsManagerContentSection from "./ReportsManagerContentSection/ReportsManagerContentSection";

const article = ARTICLES_DATA["amocrm-reports-manager"];

export default function AmocrmReportsManagerArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
