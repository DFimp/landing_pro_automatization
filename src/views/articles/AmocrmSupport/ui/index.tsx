...
import SupportContentSection from "./SupportContentSection/SupportContentSection";

const article = ARTICLES_DATA["amocrm-support"];

export default function AmocrmSupportArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
