...
import AuditOrderContentSection from "./AuditOrderContentSection/AuditOrderContentSection";

const article = ARTICLES_DATA["amocrm-audit-order"];

export default function AmocrmAuditOrderArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
