...
import IntegrationTgContentSection from "./IntegrationTgContentSection/IntegrationTgContentSection";

const article = ARTICLES_DATA["amocrm-integration-tg"];

export default function AmocrmIntegrationTgArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
