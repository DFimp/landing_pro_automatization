...
import StandardSolutionsContentSection from "./StandardSolutionsContentSection/StandardSolutionsContentSection";

const article = ARTICLES_DATA["amocrm-standard-solutions"];

export default function AmocrmStandardSolutionsArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
