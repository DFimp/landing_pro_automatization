...
import RuinedSalesContentSection from "./RuinedSalesContentSection/RuinedSalesContentSection";

const article = ARTICLES_DATA["amocrm-ruined-sales"];

export default function AmocrmRuinedSalesArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
