...
import CheckSettingsContentSection from "./CheckSettingsContentSection/CheckSettingsContentSection";

const article = ARTICLES_DATA["amocrm-check-settings"];

export default function AmocrmCheckSettingsArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
