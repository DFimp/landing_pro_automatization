...
import ImplementOrderContentSection from "./ImplementOrderContentSection/ImplementOrderContentSection";

const article = ARTICLES_DATA["amocrm-implement-order"];

export default function AmocrmImplementOrderArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
      ...
      <div className="mx-auto max-w-[1200px] px-5">
        <ArticleDescriptionSection category="CRM" tag="#СТАТЬИ" date="28.04.2026" readTime="15 минут" />
