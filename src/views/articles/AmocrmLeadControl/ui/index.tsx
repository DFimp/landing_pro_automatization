...
import LeadControlContentSection from "./LeadControlContentSection/LeadControlContentSection";

const article = ARTICLES_DATA["amocrm-lead-control"];

export default function AmocrmLeadControlArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
