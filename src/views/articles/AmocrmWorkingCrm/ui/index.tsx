...
import WorkingCrmContentSection from "./WorkingCrmContentSection/WorkingCrmContentSection";

const article = ARTICLES_DATA["amocrm-working-crm"];

export default function AmocrmWorkingCrmArticle() {
  return (
    <>
      <ArticleSchemaTag
        data={{
