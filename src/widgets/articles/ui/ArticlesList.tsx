...
const ARTICLES: Article[] = [
    ...
    },
    {
        ...
        text:
            "Чем amoCRM хороша для бизнеса: воронка продаж, омниканальность, роботы и триггеры, интеграции и ошибки настройки.",
    ...
    },
    {
        ...
        text:
            "Пошаговый чеклист быстрой настройки amoCRM: воронка продаж, источники заявок, автоматизация, задачи и аналитика без лишних действий.",
