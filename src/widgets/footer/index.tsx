  ...
  return (
    <footer id={isIframe ? "hidden-in-iframe" : ""} className="pt-6">
      <div className="w-full rounded-b-[24px] text-white
        ...
        <div className="mx-auto max-w-[1200px] px-5 py-6 sm:px-10 sm:py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/">
              <Image
          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8 md:pl-4">
            {cols.map((col, i) => (
              <div key={i}>
                {col.title ? (
      ...
      <div className="mt-3 w-full bg-[#efefef]">
        <div className="mx-auto max-w-[1200px] px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-3 text-[14px] text-[#4b4b4b]">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="https://t.me/proavtomatization_support_bot" target="_blank" className="hover:underline">
