      ...
      content: (
        <div>
          ...
          <div className="sc-note sc-note--red">
            ...
            <div>
              Если менеджер не включён ни в один из графиков (ни в отдел, ни в индивидуальный и общий график не задан) — он не будет
              получать сделки.
              <br />
          ...
          <div className="sc-note sc-note--blue">
            ...
            <div>
              В левом блоке есть список сохранённых графиков. Любой график можно применить, переименовать или удалить.
        ...
        <div>
          <div className="sc-note sc-note--blue">
            ...
            <div>
              ...
              <strong style={{ color: 'red' }}>ВАЖНО:</strong> эти параметры применяются к уже существующему графику, когда нужно точечно внести
          ...
          <div className="sc-note sc-note--blue">
            ...
            <div>
              ...
              <strong style={{ color: 'red' }}>ВАЖНО:</strong> если в триггере указан график, график и активность работают вместе. Даже если
          ...
          <div className="sc-note sc-note--green">
            ...
            <div>
              Все проверки рабочего времени выполняются в часовом поясе вашего аккаунта. Если в аккаунте не настроен часовой пояс, то по умолчанию используется
