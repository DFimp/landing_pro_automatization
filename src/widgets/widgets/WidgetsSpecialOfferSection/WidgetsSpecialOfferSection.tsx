    ...
    return (
        ...
        <div className=' mt-[90px]! container'>
            ...
            <div className="sm:flex-row flex flex-col gap-[20px] sm:gap-[40px] justify-between mb-[42px]">
                <div className="sm:max-w-[49%] flex-grow-1 border border-[#3760E7] px-[28px] py-[35px] font-[400] sm:text-[20px] text-[14px] leading-[1] rounded-[20px]">
                ...
                <div className="flex items-center sm:max-w-[49%] flex-grow-1 border border-[#3760E7] px-[28px] py-[35px] font-[400] sm:text-[20px] text-[14px] leading-[1] rounded-[20px]">
