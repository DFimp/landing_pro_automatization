...
export function CasesGrid() {
  ...
  return (
    <section className={styles.casesGrid}>
      <div className={`${styles.casesRow} ${styles.casesRowRight}`}>
        <div className={styles.casesRowGrid}>
          <CasesCard item={case1} className={styles.caseCardUnder} />
          <CasesCard
            item={case2}
            className={styles.caseCardOnTop}
            style={{ zIndex: 2 }}
          />
          <CasesCard item={case3} className={styles.caseCardUnder} />
        </div>
      </div>

      <div className={`${styles.casesRow} ${styles.casesRowLeft}`}>
        <div className={styles.casesRowGrid}>
          <CasesCard item={case4} className={styles.caseCardUnder} />
          <CasesCard
            item={case5}
            className={styles.caseCardOnTop}
            style={{ zIndex: 2 }}
          />
          <CasesCard item={case6} className={styles.caseCardUnder} />
        </div>
      </div>
    </section>
  );
