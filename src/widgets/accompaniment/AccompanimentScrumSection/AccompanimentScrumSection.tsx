        ...
        <>
            ...
            <div className='container'>
                <h4 className='sm:text-h4 sm:font-medium text-white sm:mt-40 '>
                    Такой подход позволяет <span className='font-semibold'>оперативно реагировать</span> на изменения, <span className='font-semibold'>соблюдать сроки</span> и обеспечивать высокое
                    качество работы.
                </h4>
             </div>
        </>
