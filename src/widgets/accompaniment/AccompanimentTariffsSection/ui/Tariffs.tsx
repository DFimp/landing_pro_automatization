                ...
                <ul className='flex sm:flex-row flex-col justify-between items-center gap-8'>
                    {tariffs.map((tariff: Tariff, index: number) => (
                        <motion.li
                            ...
                            key={index}
                            className='cursor-pointer card sm:border-1 shadow-[0_4px_13px_#3760E780] sm:rounded-3xl rounded-[60px] px-10 py-15 sm:max-w-85 w-full space-y-10 relative overflow-hidden bg-black' // Добавлено overflow-hidden
