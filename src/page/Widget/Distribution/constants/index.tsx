...
export const STEPS = [    {
...

    {
      ...
      content: (
        <div>
          <p>
            График определяет, в какие дни и часы виджет распределяет сделки. Это помогает не отдавать лиды в нерабочее
            время, учитывать выходные, отпуска и сменный режим.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="sc-note sc-note--blue">
            <div className="sc-note-title">
              <strong>Подробно о типах:</strong>
            </div>
            <div>
              По дням недели — стандартная неделя (например, Пн–Пт). Посменный — задайте количество рабочих и выходных
              дней в цикле (например, 2/2 или 3/1). Конкретный день — разовая настройка на выбранную дату.
            </div>
          </div>
        </div>
      ),
      ...
      content: (
        <div>
          <div className="sc-note sc-note--blue">
            ...
            <div>
              Для сохранённых графиков доступны быстрые действия: "Добавить рабочий день" и "Добавить выходной" — это
              удобно для разовых исключений, не меняя весь график.
            </div>
          </div>
          ...
          <div className="sc-note sc-note--green">
            ...
            <div>
              Если есть несколько уровней графиков, действует приоритет: график конкретного пользователя важнее графика
              отдела, а график отдела важнее общего графика для всех сотрудников.
            </div>
          </div>
        </div>
      ),
