        ...
        <>
            <ServiceSchemaTag
                data={{
                    ...
                    name: "Настройка ленты для amoCRM",
                    description: "Виджет позволяет настраивать отображение ленты событий с фильтрами и персонализацией",
                    ...
                    <>
                        <section className="dist-hero">
                            <div className="at-container">
                                <Breadcrumbs
                                    items={[
                                        ...
                                        { name: "Настройка ленты", href: "/widgets/setting-feed" },
                                    ]}
                                />
                            ...
                            <p className="dist-hero-sub">
                                Переключайтесь между задачами, примечаниями, письмами, звонками и
                                чатами одним кликом. Виджет скрывает лишнее, прячет пустые даты и
                                автоматически применяет фильтр при догрузке ленты.
                            </p>
