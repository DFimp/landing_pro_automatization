...
export const PROBLEMS: ProblemItem[] = [
  {
    ...
    text: (
      <>
        ...
        <span className="at-mark">«Документы»</span>.
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        ...
        (сделка/контакт/компания/списки). При необходимости применяйте функции:
...
export const STEPS = [
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="df-step-grid">
          <Img
            src="/widgets/DocsFlow/template_create_form.jpeg"
            alt="Создание шаблона: выбор типа и имени"
            className="df-step-media--md"
          />
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          По умолчанию вкладка «Документы» доступна всем. При необходимости
          ограничьте права:
        </p>
        <ul className="sc-list">
          <li>
            <strong>Кто может формировать</strong> — только выбранные сотрудники смогут
            создавать документы.
          </li>
          <li>
            <strong>Кто может просматривать</strong> — доступ к вкладке «Документы» в сделке
            получат только выбранные сотрудники.
          </li>
        </ul>
        <div className="df-step-grid">
          <Img
  ...
  },
  {
    ...
    content: (
      <div>
        <ul className="sc-list">
          <li>
            Откройте сделку → вкладка <strong>Документы</strong>.
          </li>
          <li>Выберите шаблон.</li>
          <li>Введите название файла и запустите генерацию.</li>
          <li>Сформированный документ появится во вкладке.</li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <div>
        <ul className="sc-list">
          <li>В воронке откройте «Настроить».</li>
          <li>Добавьте триггер «Документы».</li>
        </ul>
