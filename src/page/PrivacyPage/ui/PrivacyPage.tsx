        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-h7 text-gray">
                <strong>5.5.</strong> Также на сайте происходит сбор и обработка
                обезличенных данных о посетителях (в т.ч. файлов «cookie») с
                помощью сервисов интернет-статистики (подробнее см. раздел 13
              ...
              <p className="text-h7 text-gray">
                ...
                доступа в единую биометрическую систему (ЕБС) или единую систему
                идентификации и аутентификации (ЕСИА), используются
                унифицированные формы согласия, утвержденные Правительством РФ.
              </p>
              <p className="text-h7 text-gray">
                <strong>5.9.</strong> Обработка персональных данных, разрешенных
              ...
              <p className="text-h7 text-gray">
                ...
                действие с момента поступления Оператору требования, указанного
                в п. 5.10.3 настоящей Политики в отношении обработки
                персональных данных.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8 p-6 bg-light-blue rounded-lg">
            ...
            <div className="space-y-3">
              <p className="text-h7 text-gray">
                <strong>
                  10.1. Персональные данные обрабатываются и хранятся в течение
                  следующих сроков:
                </strong>
              </p>
              <div className="ml-4 space-y-2">
                ...
                <p className="text-h7 text-gray">
                  ...
                  коммуникаций: до отзыва согласия субъектом персональных данных
                </p>
                <p className="text-h7 text-gray">
                  <strong>10.1.4.</strong> Файлы cookie и данные веб-аналитики:
                  не более 2 лет с момента последнего посещения сайта
                </p>
                <p className="text-h7 text-gray">
              ...
              <p className="text-h7 text-gray">
                ...
                персональные данные подлежат уничтожению или обезличиванию, если
              ...
              <p className="text-h7 text-gray">
                ...
                электронный адрес Оператора info@pro-automatization.ru с
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-h7 text-gray">
                <strong>13.3.</strong> Сбор аналитических данных осуществляется
                в обезличенном виде и не позволяет идентифицировать конкретного
                пользователя.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              <p className="mb-4">
                <strong className="text-blue2">15.1.</strong> Оператор до начала
              ...
              <p className="mb-4">
                ...
                исключительно на территории Российской Федерации в соответствии
                с требованиями статьи 18 Федерального закона «О персональных
                данных».
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              <p className="mb-4">
                ...
                Федеральным законом от 30.11.2024 № 420-ФЗ «О внесении изменений
              ...
              <ul className="list-disc list-inside mb-6 ml-4 space-y-2">
                ...
                <li>
                  ...
                  зависимости от объема утечки: до 3 млн рублей, а при повторных
                  нарушениях - до 5% от годовой выручки;
                </li>
                <li>
              ...
              <p className="mb-4">
                <strong className="text-blue2">17.2.</strong> В соответствии со
                статьей 272.1 УК РФ, действующей с 11 декабря 2024 года,
              ...
              <ul className="list-disc list-inside mb-6 ml-4 space-y-2">
                ...
                <li>
                  за действия в отношении персональных данных несовершеннолетних
                  или биометрических данных - штраф до 700 000 рублей или
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              <p className="mb-4">
                <strong className="text-blue2">18.1.</strong> Оператор применяет
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc list-inside mb-6 ml-4 space-y-2">
                <li>
                  незамедлительно, но не позднее 24 часов с момента обнаружения
                  или получения сведений об инциденте, уведомляет Роскомнадзор;
                </li>
                <li>
                  проводит внутреннее расследование инцидента и в течение 72
                  часов направляет в Роскомнадзор детальный отчет о результатах
                  расследования;
                </li>
                <li>
                  при необходимости уведомляет субъектов персональных данных об
                  инциденте и принимаемых мерах по его устранению.
                </li>
              </ul>

              <p className="mb-4">
                <strong className="text-blue2">19.2.</strong> Уведомления
                направляются в Роскомнадзор в электронном виде через официальный
                сайт ведомства или на бумажном носителе.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              <p className="mb-4">
                <strong className="text-blue2">20.1.</strong> Настоящая Политика
                может изменяться и дополняться Оператором в одностороннем
                порядке в соответствии с изменениями в законодательстве
                Российской Федерации или изменениями в деятельности Оператора.
              </p>

              <p className="mb-4">
                <strong className="text-blue2">20.2.</strong> При внесении
                изменений в Политику Оператор размещает уведомление на сайте не
                менее чем за 10 дней до вступления изменений в силу.
              </p>

              <p className="mb-4">
                <strong className="text-blue2">20.3.</strong> Продолжение
                использования сайта после внесения изменений в Политику означает
          ...
          <section className="mb-8">
            ...
            <div className="mb-8">
              <p className="mb-4">
                <strong className="text-blue2">21.1.</strong> Пользователь может
              ...
              <p className="mb-4">
                <strong className="text-blue2">21.2.</strong> В данном документе
              ...
              <p className="mb-4">
                <strong className="text-blue2">21.3.</strong> Актуальная версия
